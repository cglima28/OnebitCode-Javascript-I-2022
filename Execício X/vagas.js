...
function novaVaga() {
  ...
  const descricao = prompt("Infome uma descrição para a vaga: ");
  const dataLimite = prompt("Informe a data limite (dd/mm/aaa) para a vaga: ");
...
function inscreverCandidato() {
  ...
  const indice = prompt(
    "Informe o índice da vaga para o queal o(a) candidato(a) deseja se inscrever"
  );
  const vaga = vagas[indice];
